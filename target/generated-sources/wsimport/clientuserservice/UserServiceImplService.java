 ...
 * 
 */
@WebServiceClient(name = "UserServiceImplService", targetNamespace = "http://userpackage/", wsdlLocation = "http://localhost:8010/userservice?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICEIMPLSERVICE_QNAME = new QName("http://userpackage/", "UserServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8010/userservice?wsdl");
    ...
    public UserService getUserServiceImplPort() {
        return super.getPort(new QName("http://userpackage/", "UserServiceImplPort"), UserService.class);
    }
    ...
    public UserService getUserServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://userpackage/", "UserServiceImplPort"), UserService.class, features);
    }
